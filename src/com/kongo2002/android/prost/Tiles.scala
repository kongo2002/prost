...
object Tiles extends Enumeration {
  ...
  def get(name: Tiles, activity: TypedActivityHolder) : Tile = {
    name match {
...
abstract class Tile(pos: Tiles, text: Int, label: Int, lay: Int, activity: TypedActivityHolder) {
  def position = pos
